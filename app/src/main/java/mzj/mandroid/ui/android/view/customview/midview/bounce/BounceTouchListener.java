...
public class BounceTouchListener implements View.OnTouchListener {
     ...
     * @return A new BounceTouchListener attached to the given scrollable view
     */
    public static BounceTouchListener create(View mainView, @IdRes int contentResId,  @Nullable OnTranslateListener onTranslateListener) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (mSwipingDown || mSwipingUp) {
                    if ((deltaY <= 0 && mSwipingDown) || (deltaY >= 0 && mSwipingUp)) {
                        ...
                        downEvent.setAction(MotionEvent.ACTION_DOWN |   (MotionEventCompat.getActionIndex(motionEvent) << MotionEventCompat.ACTION_POINTER_INDEX_SHIFT));
    ...
    private boolean hasHitBottom() {
        if (mMainView instanceof ScrollView) {
            ...
            Log.e("TAG", "hasHitBottom->diff:" + diff);
            return diff == 0;
