package mzj.mandroid.ui.android.view.customview.superview;
 ...
 */
public class SuperViewListAct extends BaseActivity<CommentTitleListBinding> {
    ListAdapter adapter;
    @Override
    ...
    protected void initData() {
        ...
        list.add(new TitleModel.Bean("简单自定义View",RxCacheAct.class));
